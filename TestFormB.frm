VERSION 5.00
Object = "{16667E8F-14A0-4119-B28F-4C0369C8B199}#2.0#0"; "sbdlt4.ocx"
Begin VB.Form TestFormB 
   ...
   Begin VB.CommandButton Command6 
      ...
      Width           =   1215
   End
   Begin sbdlt4.DataLTab LightTab1 
      Height          =   2655
      Left            =   120
      TabIndex        =   24
      Top             =   120
      ...
      Begin VB.TextBox Text1 
         ...
         Width           =   4575
      End
      Begin sbdlt4.DataHWLabel DataHWLabel1 
         Height          =   255
         Left            =   120
         TabIndex        =   17
         Top             =   2280
...
If LightTab1.TabCaption(1) = "Tab1" Then
    LightTab1.TabCaption(1) = "VeryLongTabCaption1"
    LightTab1.TabCaption(2) = "VeryLongTabCaption2"
Else
    LightTab1.TabCaption(1) = "Tab1"
    LightTab1.TabCaption(2) = "Tab2"
End If
...
If Command3.Caption = "Add" Then
    ...
    MsgBox "Before " & LightTab1.TotalTabs

    LightTab1.TotalTabs = LightTab1.TotalTabs + 1

    MsgBox "After " & LightTab1.TotalTabs
...
TestFormB.Caption = "FormB - StateMode=" & LightTab1.StateMode & " - OffsetMode=" & LightTab1.OffsetMode & " - FlatMode=" & LightTab1.FlatMode
